...
map('n', '<C-s>', ':w! <CR>')
map('n', '<C-S>', ':wa! <CR>')
map('n', '<C-a>', 'gg^vG$', { silent = true, noremap = true })
map('i', '<C-s>', '<Esc> :wa <CR>')
...
map('x', 'p', '"_dP', { silent = true, desc = 'Paste without losing the original', noremap = true })
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      require('mini.indentscope').setup {
        draw = { animation = require('mini.indentscope').gen_animation.none(), delay = 0 },
      }
